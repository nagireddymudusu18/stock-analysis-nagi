      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            disabled={loading}
            className="bg-primary text-white px-6 py-2 rounded-lg hover:bg-blue-800 transition disabled:bg-gray-400"
          >
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {results.map((stock) => (
                  <tr key={stock.symbol} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">{stock.peRatio.toFixed(2)}</td>
